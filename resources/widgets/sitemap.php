...
class Widget_Sitemap extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => 'widget_sitemap',
            'description' => 'This is a sitemap',
            'customize_selective_refresh' => true,
		);
		parent::__construct( 'widget_sitemap', 'Sitemap', $widget_ops );
	}

	public function widget( $args, $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Sitemap' );
